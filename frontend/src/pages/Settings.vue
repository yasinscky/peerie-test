...
const texts = computed(() => {
  ...
  return {
    ...
    deleteAccountError: 'Account deletion error',
      emailChangeCodeSent: 'We have sent a confirmation code to your new email address.',
      emailChangeConfirmed: 'Email updated successfully!',
      emailChangeError: 'Email change error',
      emailVerificationMessage: 'Please enter the confirmation code sent to your new email address.',
      emailVerificationCodePlaceholder: 'Enter confirmation code',
